...
import { Phone, MapPin, Clock, ArrowRight, Navigation, Sparkles, Star, ChevronDown } from "lucide-react";
import { LOCATIONS } from "@/data/site";
import bannerImg from "@/assets/banner-5.webp"; // ← the food spread image you provided
...
/* ─── tilt hook (same pattern as home page) ─── */
...
/* ─── location detail accordion (mobile) ─── */
      ...
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; }
        ...
        @media(max-width:900px){
          .wml-hero__inner { grid-template-columns: 1fr; padding: 0 24px 64px; }
        }
        ...
        .wml-shimmer {
          ...
          animation: wml-shimmer 4s linear infinite;
        }
        @keyframes wml-shimmer {
          0%   { background-position: -200% center; }
          100% { background-position:  200% center; }
        }
        .wml-hero__sub {
          font-size: 16px; color: rgba(255,255,255,0.48);
          line-height: 1.75; margin-top: 20px; max-width: 460px;
        }
        .wml-hero__ctas { display: flex; flex-wrap: wrap; gap: 12px; margin-top: 32px; }

        /* hero right — quick-stat cards */
        .wml-hero__stats {
        ...
        .wml-stat-card__num {
          ...
          font-size: 38px; font-weight: 700; color: #d97706; line-height: 1;
        }
        ...
        /* alternate: even cards flip map to right */
        ...
        /* map pane */
        .wml-card__map {
          position:relative; min-height:320px; background:#161412;
          overflow:hidden; flex-shrink:0;
        }
        .wml-card__map iframe {
          position:absolute; inset:0; width:100%; height:100%; border:0;
          filter: saturate(0.4) brightness(0.7);
          transition: filter .4s;
        }
        .wml-card:hover .wml-card__map iframe { filter: saturate(0.7) brightness(0.85); }
        ...
        .wml-card__pin {
          ...
          color:#fff; box-shadow:0 8px 24px rgba(217,119,6,.45);
        ...
        /* info pane */
        .wml-card__info { padding:40px 44px; position:relative; z-index:1; display:flex; flex-direction:column; justify-content:center; }
        ...
        .wml-btn-primary {
          ...
          padding:11px 22px; background:#d97706; color:#fff;
        ...
        .wml-cta-title {
          font-family:'Cormorant Garamond',serif;
          font-size:clamp(32px,4vw,52px); font-weight:700; color:#fff; line-height:1.05; position:relative;
        }
        ...
        /* ── map hover state glow ── */
        .wml-card__map::after {
          content:''; position:absolute; inset:0; z-index:1;
          background: linear-gradient(to right, rgba(10,9,8,0.18) 0%, transparent 40%);
          pointer-events:none;
        }
      `}</style>
        ...
        <section className="wml-hero" ref={heroRef}>
          <motion.div
            ...
            style={{
              ...
              y: bgY, opacity: bgOpacity, scale: bgScale,
            }}
          />
          ...
          <div className="wml-hero__inner">
            ...
            {/* RIGHT — floating quick-stat cards */}
              ...
              <TiltCard strength={5}>
                <div className={`wml-card${i % 2 !== 0 ? " wml-card--flip" : ""}`}>
                  ...
                  <div className="wml-card__info">
                    ...
                    <h2 className="wml-card__name">{loc.name}<br /><span style={{ color: "rgba(255,255,255,0.35)", fontSize: "0.6em", fontWeight: 600 }}>{loc.state}</span></h2>
